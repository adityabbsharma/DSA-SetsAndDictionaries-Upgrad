/*
* Balanced BST
* Given a binary tree, construct a balanced binary search tree consisting of the sum of each node and
* its children (Note: All its children and not immediate children). The output should be the postOrder
* traversal of the new binary search tree.
...
And so on
Once this new binary tree is constructed, you can print any traversal of this new binary tree and sort that
